    ...
    <nav class="navbar">
    	<div class="container-fluid">
    		<div class="navbar-header">
    			...
    			<a class="navbar-brand" href="index.html">Admin - Bimbel Demi Pena</a>
    		</div>
    ...
    <section>
    	...
    	<aside id="leftsidebar" class="sidebar">
    			...
    			<div class="info-container">
    				...
    				<div class="btn-group user-helper-dropdown">
    					...
    					<ul class="dropdown-menu pull-right">
    						...
    						<li><a href="<?= base_url('admin/auth/logout') ?>"><i class="material-icons">input</i>Sign Out</a></li>
    					</ul>
    				</div>
    			</div>
    		</div>
    		...
    		<div class="menu">
    			<ul class="list">
					...
					<?php if ($this->session->userdata('status') != 2) : ?>
						<li class="<?php echo ($title == 'materi') ? 'active' : ''; ?>">
    						<a href="<?= base_url(); ?>admin/materi">
    							<i class="material-icons">local_library</i>
    							<span>Materi dan Soal</span>
    						</a>
    					</li>
				
						<li class="<?php echo ($title == 'nilai') ? 'active' : ''; ?>">
    						<a href="<?= base_url(); ?>admin/siswa/nilai">
    							<i class="material-icons">local_library</i>
    		...
    		<div class="legal">
    			<div class="copyright">
    				&copy; 2024 <a href="javascript:void(0);">Bimbel Demi Pena</a>.
    			</div>
    			<div class="version">
    				<b>Version: </b> 1.0
    			</div>
