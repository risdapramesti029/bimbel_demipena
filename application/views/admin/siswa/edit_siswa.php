...
<section class="content">
	<div class="container-fluid">
		<div class="block-header">
			<h2>Demi Pena MANAJEMEN USER</h2>
		</div>
				...
				<div class="card">
					<div class="header">
						<h2 style="font-weight: bold;color: #ad1455;font-size: 22px;">
							<center>FORM EDIT ADMIN BIMBEL DEMI PENA</center>
							<br>
						</h2>
					</div>
						...
						<div class="row clearfix">
							...
							<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
								<div class="form-group">
									<div class="form-line">
										<input type="text" value="<?= $detail['nama'] ?>" class="form-control" placeholder="Ex : xxx" name="nama" required autocomplete="off" />
									</div>
								</div>
							</div>
						</div>
