 				...
 				<div class="bg-light align-self-stretch box p-4 " style="border-radius: 1%;">
 								...
 								<div class="form-line">
 									...
 									<center>
										<?php if (isset($profile['foto']) && !empty($profile['foto'])): ?>
											<img src="<?= base_url(); ?>assets/upload/foto/<?= $profile['foto'] ?>" alt="" style="min-height:220px;max-height:220px;min-width:340px;max-width:340px;">
										<?php else: ?>
											<img src="<?= base_url(); ?>assets/upload/foto/default.jpg" alt="" style="min-height:220px;max-height:220px;min-width:340px;max-width:340px;">
										<?php endif; ?>
									</center>
									<center>
 					...
 					<div class="row clearfix">
 						...
 						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
 							<div class="form-group" style="margin-bottom: 1.8rem;">
 								<div class="form-line">
 									<input type="text" class="form-control" placeholder="Nama Lengkap" value="<?= (isset($profile['nama']))  ? $profile['nama'] : ""; ?>" name="nama"> </label>
 								</div>
 							</div>
 						</div>
 					</div>
 					...
 					<div class="row clearfix">
						 ...
						 <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
 							<div class="form-group" style="margin-bottom: 1.8rem;">
 								<div class="form-line">
								 <select name="pendidikan" id="asd" class="form-control">
									<option value="" selected="" disabled="">-- Pilih Jenjang Pendidikan --</option>
									<?php foreach ($pendidikan as $jenjang) : ?>
										<option value="<?= $jenjang['value']; ?>" <?= ($profile['pendidikan'] == $jenjang['value']) ? 'selected' : ''; ?>>
											<?= $jenjang['label']; ?>
										</option>
									<?php endforeach; ?>
								</select>
 ...
 <script>
    ...
    $('.datepicker').datepicker({
        // Konfigurasi datepicker disini
        dateFormat: 'yy-mm-dd' // Contoh format tanggal
    });
});
 </script>
