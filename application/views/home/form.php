 			...
 			<div class="col-md-4">
 				<div class="bg-light align-self-stretch box p-4 text-center">
 					...
 					<p style="color: red;">
 						...
 						Rincian Pembayara : Sesuai kelas yang diambil <br>

 						Nomor rekening : 12345678910</p>
 				</div>
 			</div>
 				...
 				<div class="bg-light align-self-stretch box p-4 " style="border-radius: 1%;">
 					...
 					<div class="row clearfix">
 						...
 						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
 							<div class="form-group" style="margin-bottom: 1.8rem;">
 								<div class="form-line">
 									<input type="text" class="form-control" placeholder="Pendidikan" value="<?= (isset($profile['pendidikan']))  ? $profile['pendidikan'] : ""; ?>" name="pendidikan" required autocomplete="off" disabled />
										<select name="jenjang_kelas" class="form-control">
											<?php foreach ($jenjang_kelas as $jenjang): ?>
