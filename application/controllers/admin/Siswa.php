...
class Siswa extends CI_Controller
{
	...
	{
		$data['title'] = 'nilai';
		$data['list_nilai_siswa'] = $this->siswa_model->nilai_siswa();
		$data['layout'] = 'admin/siswa/nilai_siswa';
		$this->load->view('admin/layout_admin', $data);
	}
	...
	public function delete_nilai($id)
	{
		...
		$this->session->set_flashdata('message', 'Nilai berhasil dihapus!');
		redirect(base_url('admin/siswa/nilai'));
	}
}
